...
class FunctionTests extends IntegrationTest {
  ...
  testFile("wacc_example/valid/function/simple_functions/", new File("functionDoubleReturn.wacc"), skip = true) // /n
  testFile("wacc_example/valid/function/simple_functions/", new File("functionIfReturns.wacc"), skip = true) // /n
  testFile("wacc_example/valid/function/simple_functions/", new File("functionManyArguments.wacc"), skip = true) // contain address
  testFile("wacc_example/valid/function/simple_functions/", new File("functionMultiReturns.wacc"), skip = false) // stuck
  ...
  // testFile("wacc_example/valid/function/simple_functions/", new File("sameArgNameVar.wacc"), skip = false)
  // testFile("wacc_example/valid/function/simple_functions/", new File("usesArgumentWhilstMakingArgument.wacc"), skip = false)
