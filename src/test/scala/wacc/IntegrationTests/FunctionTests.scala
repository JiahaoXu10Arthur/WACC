...
class FunctionTests extends IntegrationTest {
  ...
  // testFile("wacc_example/valid/function/nested_functions/", new File("mutualRecursion.wacc"), skip = false) // Fail
  // testFile("wacc_example/valid/function/nested_functions/", new File("printInputTriangle.wacc"), skip = false) // Fail - stuck
  // testFile("wacc_example/valid/function/nested_functions/", new File("printTriangle.wacc"), skip = false) // Fail - stuck
